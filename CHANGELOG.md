...
## [1.0.1](https://github.com/jackster1209/infinidysk/compare/v1.2.2...v1.0.1) (2026-08-22)
...
* **nntp:** allow disabling yEnc CRC validation via USENET_DISABLE_CRC_VALIDATION ([e0d10aa](https://github.com/jackster1209/infinidysk/commit/e0d10aa2605f034869885f68e9b1ac38e35dbb0e))
* **nntp:** fail fast with a logged yEnc native self-test at startup ([ec48e9d](https://github.com/jackster1209/infinidysk/commit/ec48e9d2b879c8cff3c5115f32d570acd923056c))
...
* **ui:** add 35 GB and 50 GB options to the Usenet speed test ([54de9e4](https://github.com/jackster1209/infinidysk/commit/54de9e40b8b5401efb07c964d7f538bfb3d43a8e))
* **ui:** add 35 GB and 50 GB speed-test data budgets ([f65f7cd](https://github.com/jackster1209/infinidysk/commit/f65f7cdcfdfd1ed96ff74038ef5bd6279ad33d34))
...
* **ui:** show queue totals and selectable page sizes ([906cf72](https://github.com/jackster1209/infinidysk/commit/906cf72ea012dec2a23d8b437c5ae123b8ba5ef4))
* **ui:** show queue totals and selectable page sizes on the Queue page ([8a54639](https://github.com/jackster1209/infinidysk/commit/8a546399e8a72b6354a7b796263f9dbf0ef8de0d))
...
* **deps:** bump NzbDav.SharpCompress to 0.53.1 with bounded 7z recursion ([bf4b436](https://github.com/jackster1209/infinidysk/commit/bf4b43606e00d8a9d7dbf426fa0e70adae3fbeb8))
* **deps:** bump NzbDav.UsenetSharp to 3.1.3 for musl rapidyenc ([f009c9b](https://github.com/jackster1209/infinidysk/commit/f009c9b6479169f3dc5f32f1fe9813bc719fd1dc))
...
* **deps:** bump SharpCompress so deep 7z coder chains fail safely ([cb71c15](https://github.com/jackster1209/infinidysk/commit/cb71c151e2171f404176ab7b206eb83c3a97c9b2))
...
* **deps:** bump UsenetSharp so Alpine images get musl-native yEnc decode ([eeff02b](https://github.com/jackster1209/infinidysk/commit/eeff02bcf6e510739142b8bddd8bbb2c2c0426a0))
...
* **deps:** resolve merge keeping UsenetSharp 3.1.3 and SharpCompress 0.53.1 ([d16405d](https://github.com/jackster1209/infinidysk/commit/d16405d0a1652ee4a78a678f9527fdc1cd99ba4e))
...
* **docker:** container shutdown logs the backend exit code and fatal signal ([49a6473](https://github.com/jackster1209/infinidysk/commit/49a647325d8fb540536f2ad37d5ea2c09ade516f))
...
* **docker:** log the backend exit code and fatal signal when the container shuts down ([edee229](https://github.com/jackster1209/infinidysk/commit/edee229fe6639a2907f8df37663c4bda28697aa9))
...
* **nntp:** connection permit release no longer throws from download callbacks ([95b18c0](https://github.com/jackster1209/infinidysk/commit/95b18c0bbfeb4fb0a4e0890849d70bf2cc44cd08))
* **nntp:** fail fast on broken yEnc natives and catch Alpine decode crashes in CI ([c9c42eb](https://github.com/jackster1209/infinidysk/commit/c9c42eb5801a6f59ba271faa96709c3e50728d8c))
...
* **nntp:** health checks and import probes stay fast when NNTP pipelining is on ([2b7d462](https://github.com/jackster1209/infinidysk/commit/2b7d462e30d27bb4a849dfe5a7ce580547e8cb86))
...
* **nntp:** make connection-permit release safe inside completion callbacks ([a691499](https://github.com/jackster1209/infinidysk/commit/a6914994b537b7b47621ee91daff8b54d3ccd643))
* **nntp:** only log provider recovery when the circuit actually opened ([5b33db1](https://github.com/jackster1209/infinidysk/commit/5b33db18bc82b34b023dfdba3b66efbca52f572c))
* **nntp:** only log provider recovery when the circuit actually opened ([48e79d7](https://github.com/jackster1209/infinidysk/commit/48e79d7f8919a533b52472e6eb5283c30622c06f))
...
* **nntp:** tighten handshake timeout filters and Test Connection logs ([c3aae89](https://github.com/jackster1209/infinidysk/commit/c3aae89c0ec23e544134cdde65ecafacf6953aca))
* **nntp:** timed-out provider handshakes report as connect or login failures ([f5eea1e](https://github.com/jackster1209/infinidysk/commit/f5eea1ef760c956a02c0f07094244d66b62c29c7))
* **nntp:** type handshake timeouts as connect or login failures ([a9c8e2f](https://github.com/jackster1209/infinidysk/commit/a9c8e2fc54c1ac32a37172bab87bac27eb4435fd))
...
* **queue:** progress broadcasts can no longer crash the backend from a timer callback ([016f6e0](https://github.com/jackster1209/infinidysk/commit/016f6e04c99d7fb1a24cd0703c0c8465c0aad494))
...
* **queue:** queue processing starts only after the web host is healthy ([015ffdd](https://github.com/jackster1209/infinidysk/commit/015ffdddc27465e5de84ffcbb9dce41702020fbd))
* **queue:** queue progress updates no longer crash the backend on a bad callback ([9fc3841](https://github.com/jackster1209/infinidysk/commit/9fc384167f9ad3eebdc17ce534298c2a43b2f13e))
...
* **queue:** start queue processing only after the web host is serving ([8bd9240](https://github.com/jackster1209/infinidysk/commit/8bd924047b09e0119da72633ab0e0e4cc61e7ba5))
* **queue:** stop advertising huge sentinel sizes for multipart RAR files ([3a74b4d](https://github.com/jackster1209/infinidysk/commit/3a74b4d765ab8ebbd17479d5ef3f57374d4f0a0f))
* **queue:** stop advertising Int64.MaxValue as multipart RAR FileSize ([e5eb704](https://github.com/jackster1209/infinidysk/commit/e5eb70410a82e40160ad7c71699d500853f25dc7))
...
* **ui:** keep live updates connected across backend websocket relay drops ([9f8e809](https://github.com/jackster1209/infinidysk/commit/9f8e809b312d3d4cfd03f2af090e5d6df2334811)), closes [#515](https://github.com/jackster1209/infinidysk/issues/515)
...
* **ui:** keep short provider circuit trips visible on Outages spark ([17720ca](https://github.com/jackster1209/infinidysk/commit/17720cadd0c1328c95fe3ae953d83bea9a87fdf5)), closes [#526](https://github.com/jackster1209/infinidysk/issues/526)
...
* **ui:** live Overview and Queue updates no longer stall until refresh ([4499595](https://github.com/jackster1209/infinidysk/commit/44995954d66e74fb502baab7a0ac08c3e2657ca1))
...
* **ui:** Outages sparkline no longer hides brief provider circuit trips ([524dd24](https://github.com/jackster1209/infinidysk/commit/524dd247ce578820c5c3338cfcc96ff952e9db88))
...
* **ui:** stop the read sessions panel overflowing at full width ([ddd36be](https://github.com/jackster1209/infinidysk/commit/ddd36be9f6617ba2ee78a67ddf1c9e03e1ae8143))
* **ui:** stop the read sessions panel overflowing at full width ([dfcfef0](https://github.com/jackster1209/infinidysk/commit/dfcfef042490274eb2214cd69a16f8d57d42ebc0))
...
* **queue:** cap import pipelining depth to bound first-segment memory ([b690fa8](https://github.com/jackster1209/infinidysk/commit/b690fa8508094a4fe0d3b6691dd9f53a7c524645))
...
* **queue:** limit first-segment import pipelining to reduce memory spikes ([42f0273](https://github.com/jackster1209/infinidysk/commit/42f02737458459fb5850324613610462afc03c8c))
...
* add migration paths from nzbdav-dev and community forks ([96ff4c9](https://github.com/jackster1209/infinidysk/commit/96ff4c91f25f1a67cfce8a76003125f43f5b2179))
* add since-version pills for 0.8.0 features ([075a0ac](https://github.com/jackster1209/infinidysk/commit/075a0ac9b4f0f19bd9ceca8b92d5faef1c188cdd))
* align Effort scale with Size (XS–XL) ([87ea0b9](https://github.com/jackster1209/infinidysk/commit/87ea0b92b92401c78f6eb359dd75b566139af6a2))
* clarify homepage legal-use disclaimer for public domain content ([1edf4c4](https://github.com/jackster1209/infinidysk/commit/1edf4c4d67b7a5f2bc6b700f784af0999f9a5ff9))
* **docker:** explain how to change the published port ([7527c09](https://github.com/jackster1209/infinidysk/commit/7527c0944b66bf084f392575d490ad6b873f217a))
* **docker:** explain port mapping and listener overrides ([29b7393](https://github.com/jackster1209/infinidysk/commit/29b73931e196e4e21d5529dd679afd52f009b079))
* document current issue triage and milestone practice ([25546bd](https://github.com/jackster1209/infinidysk/commit/25546bde44eee6f03d78310359d0651f2e282992))
* document current issue triage and milestone practice ([568b471](https://github.com/jackster1209/infinidysk/commit/568b4719ee58a9e17710c1cd4ef51cb5e501c2a3))
* feature Discord invite in community and footer socials ([258ad3f](https://github.com/jackster1209/infinidysk/commit/258ad3f53f594e65ceca33ac655e1e59005d44ed))
* forbid agents from merging pull requests ([6114927](https://github.com/jackster1209/infinidysk/commit/611492746fbedd8beada84494333f1408745d24c))
* hide Made with Zensical footer credit ([13c6a7b](https://github.com/jackster1209/infinidysk/commit/13c6a7b36a4e949bb6bf09a0d5cf0ed7c25b0324))
* migrate Discord invite and document July 21 transition ([a955a6e](https://github.com/jackster1209/infinidysk/commit/a955a6e0b74d7f28a34ac66a6e290fb5596c450b))
* note NzbDAV as a fully supported DUMB core module ([776f10e](https://github.com/jackster1209/infinidysk/commit/776f10edf7a579e9e5c9df7aaf7f22bf0ad73e7a))
* note same-origin /ws WebSocket requirement for reverse proxies ([a4168e7](https://github.com/jackster1209/infinidysk/commit/a4168e75d70540ded5dcd5c56b6dd6f05e5279c0))
* point community Discord at the new server ([20ef599](https://github.com/jackster1209/infinidysk/commit/20ef5998073e970be1a7d3c57978147630952333))
* rebuild nzbdav.com as a branded product docs site ([2d1a6f7](https://github.com/jackster1209/infinidysk/commit/2d1a6f703b4ae694fb15a1552ccc684ec3e385b2))
* rebuild nzbdav.com site with branded guides and settings reference ([64a215d](https://github.com/jackster1209/infinidysk/commit/64a215d5cbffbd8cfd4817db9a2b5c5f2f1579e5))
* show when features shipped with since-version pills ([3764bd9](https://github.com/jackster1209/infinidysk/commit/3764bd916f7e59090320e52b9c5520304c2ff1ec))
* **ui:** shrink homepage hero screenshot so it dominates less ([ddcc7c4](https://github.com/jackster1209/infinidysk/commit/ddcc7c48bedc059370fa2f430f3d961420a2c7d6))
* **ui:** use product logo in header and mid-size the hero screenshot ([5fec824](https://github.com/jackster1209/infinidysk/commit/5fec8241896c408ddfd665dc1bb240d6e9efe7d0))
* **ui:** use README product screenshot as the homepage hero ([37bdb9d](https://github.com/jackster1209/infinidysk/commit/37bdb9d4dfe4d9c9f52b2b13846d23f188376997))
* use Issue Priority/Effort fields instead of labels ([a04f392](https://github.com/jackster1209/infinidysk/commit/a04f39204ad73a16bbfc6632dbb749f9ab808850))
* use NzbDAV casing, add alternatives comparison, shrink badges ([c2db122](https://github.com/jackster1209/infinidysk/commit/c2db122840990f360f86b1fb4aec40a08867b364))
* use NZBDav Ecosystem project fields for Priority and Effort ([a5786ba](https://github.com/jackster1209/infinidysk/commit/a5786ba97a226140a4944b87ef5ef3362e61b8df))
...
* **health:** resolve depth to an enum instead of a sentinel double ([faf441a](https://github.com/jackster1209/infinidysk/commit/faf441a28a88ed216934997f332a24107277f598))
* **health:** resolve depth to an enum instead of a sentinel double ([3ebbb01](https://github.com/jackster1209/infinidysk/commit/3ebbb016abced73f679cb0a48364858ab96135e4))
