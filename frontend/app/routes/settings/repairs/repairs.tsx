        ...
        >
          ...
          <ManagedSetting configKey="repair.healthcheck-workers">
            <div className="space-y-2">
              ...
              >
                Maximum library files checked at the same time. Concurrent checks share the connection
                limit above; for example, two checks share 50 connections rather than receiving 50 each.
              </p>
            </div>
          </ManagedSetting>
          <ManagedSetting
